...
const projects = [
  ...
  },
  {
    ...
    title: 'SportVision',
    description: 'Aplicação de NLW#04 da Rocketseat. Desenvolvida com React. Plataforma de Pomodoro com exercícios',
    technologies: ['ReactNative', 'Expo', 'Redux Toolkit'],
    badge: 'Individual Project',
    image: '/placeholder-project.jpg',
  },
  {
    id: 'project4',
    title: 'QuizMaster',
    description: 'A real-time multiplayer quiz game that demonstrates core Java network programming concepts through live client–server communication, delivering an interactive and scalable quiz experience.',
